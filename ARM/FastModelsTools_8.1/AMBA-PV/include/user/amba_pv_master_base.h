/*
 * AMBA-PV: amba_pv_master_base.h - Base class for all AMBA-PV master modules.
 *
 * Copyright 2007-2009 ARM Limited.
 * All rights reserved.
 */

#ifndef AMBA_PV_MASTER_BASE__H
#define AMBA_PV_MASTER_BASE__H

/**
 * @file        amba_pv_master_base.h
 *
 ...
 * @brief       Base class for all AMBA-PV master modules.
 *
 * amba_pv_master_base is intended to be bound to one or more
 ...
 */
inline void
amba_pv_master_base::invalidate_direct_mem_ptr(int,
                                               sc_dt::uint64,
                                               sc_dt::uint64) {
}
...
#endif  /* defined(AMBA_PV_MASTER_BASE__H) */
