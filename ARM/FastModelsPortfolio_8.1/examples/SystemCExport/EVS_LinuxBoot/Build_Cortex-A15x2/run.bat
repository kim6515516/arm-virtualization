...
.\EVS_LinuxBoot_Cortex-A15x2.exe -a LinuxBoot.cluster.*=%axf% -C LinuxBoot.motherboard.mmc.p_mmc_file=%image% -C LinuxBoot.motherboard.vis.cpu_name="- LinuxBoot EVS - Cortex-A15x2" %*
