...
./EVS_bigLITTLE_Cortex-A15x4-A7x4.x -a ${axf} -C "bigLITTLE.motherboard.mmc.p_mmc_file=${image}" -C bigLITTLE.motherboard.vis.cpu_name="- bigLITTLE EVS - Cortex-A15x4-A7x4" $*
