...
./EVS_bigLITTLE_Cortex-A15x1-A7x1.x -a ${axf} -C "bigLITTLE.motherboard.mmc.p_mmc_file=${image}" -C bigLITTLE.motherboard.vis.cpu_name="- bigLITTLE EVS - Cortex-A15x1-A7x1" $*
