...
/** \file
 * Class definition for protocol FVP_VE_Cortex_A15x1__CompoundPortLisa.
 */

#ifndef FVP_VE_Cortex_A15x1__CompoundPortLisa_ClassDef_h_
#define FVP_VE_Cortex_A15x1__CompoundPortLisa_ClassDef_h_
...
class FVP_VE_Cortex_A15x1__CompoundPortLisa;
...
public:
    ...
    void SetPort(FVP_VE_Cortex_A15x1__CompoundPortLisa *port) { thisPort = port; }
...
private:
    ...
    FVP_VE_Cortex_A15x1__CompoundPortLisa *thisPort;
};


// Protocol (port) class definition
class FVP_VE_Cortex_A15x1__CompoundPortLisa: public sg::Port
{
private:
...
public:
    ...
    FVP_VE_Cortex_A15x1__CompoundPortLisa()
    {
...
// Mapping object
// (these ports are implemented inside FVP_VE_Cortex_A15x1__CompoundPortLisa__AddressablePort)
class FVP_VE_Cortex_A15x1__CompoundPortLisa__AddressablePort_OutPort: public FVP_VE_Cortex_A15x1__CompoundPortLisa
{
public:
    // constructor
    FVP_VE_Cortex_A15x1__CompoundPortLisa__AddressablePort_OutPort(MxU32 inFirst,
                                                 MxU32 inLast,
                                                 MxU32 outFirst,
                                                 MxU32 outLast):
    inFirst__(inFirst),
...
class FVP_VE_Cortex_A15x1__CompoundPortLisa__AddressablePort: public FVP_VE_Cortex_A15x1__CompoundPortLisa
{
public:
    ...
    FVP_VE_Cortex_A15x1__CompoundPortLisa__AddressablePort():
    defaultOutPort__(0),
    portName__("(unknown name)")
    {
        ...
        bind_method(*this, mapRange, &FVP_VE_Cortex_A15x1__CompoundPortLisa__AddressablePort::mapRange__, this);
        bind_method(*this, mapDefault, &FVP_VE_Cortex_A15x1__CompoundPortLisa__AddressablePort::mapDefault__, this);
        bind_method(*this, unmapRange, &FVP_VE_Cortex_A15x1__CompoundPortLisa__AddressablePort::unmapRange__, this);
        bind_method(*this, isMapped, &FVP_VE_Cortex_A15x1__CompoundPortLisa__AddressablePort::isMapped__, this);
    ...
    FVP_VE_Cortex_A15x1__CompoundPortLisa__AddressablePort_OutPort *locateOutPort__(MxU32 &addr)
    {
        OutPortList__::iterator it;
        for (it = outPortList__.begin(); it != outPortList__.end(); ++it)
        {
    ...
    {
        FVP_VE_Cortex_A15x1__CompoundPortLisa__AddressablePort_OutPort *masterPort =
            new FVP_VE_Cortex_A15x1__CompoundPortLisa__AddressablePort_OutPort(inFirst, inLast, outFirst, outLast);
    ...
    {
        delete defaultOutPort__;
        defaultOutPort__ = new FVP_VE_Cortex_A15x1__CompoundPortLisa__AddressablePort_OutPort(0, MxU32(0) - 1, 0, MxU32(0) - 1);
        return defaultOutPort__;
    }

    void unmapRange__(sg::Port* port)
    {
        outPortList__.remove((FVP_VE_Cortex_A15x1__CompoundPortLisa__AddressablePort_OutPort*)port);
...
private:
    typedef std::list<FVP_VE_Cortex_A15x1__CompoundPortLisa__AddressablePort_OutPort*> OutPortList__;
    OutPortList__ outPortList__;
    FVP_VE_Cortex_A15x1__CompoundPortLisa__AddressablePort_OutPort *defaultOutPort__;
