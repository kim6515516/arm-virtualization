...
/** \file
 * Class definition for Component HostBridge.
 */

#ifndef Component_Component__HostBridge_ClassDef_h_
#define Component_Component__HostBridge_ClassDef_h_
...
#line 17 "/home/sxcheng/Workspace/kvm/ARM/FastModelsPortfolio_8.1/LISA/HostBridge.lisa"
...
#line 49 "./Linux64-Release-GCC-4.4/gen/Component__HostBridge_ClassDef.h"
...
#endif
Component__HostBridge: public SystemGenComponent
{
public:
    ...
    // abstract ports
	FVP_VE_Cortex_A15x1__VirtualEthernet eth;
...
#line 29 "/home/sxcheng/Workspace/kvm/ARM/FastModelsPortfolio_8.1/LISA/HostBridge.lisa"

        const std::string  interfaceName     ;
        const bool  userNetworking     ;
        const std::string  userNetSubnet     ;
        const std::string  userNetPorts     ;

        // This might point to a VEPTun instance or a UserNet instance
        AsyncReader* vt;
    
#line 99 "./Linux64-Release-GCC-4.4/gen/Component__HostBridge_ClassDef.h"
    ...
    Component__HostBridge(const char *argv, sg::SimulationContext* simulationContext, const sg::Params & params);
    ~Component__HostBridge();
	...
	void step();
	void abstract_port__eth__sendToMaster(EthernetFrame* frame);
...
private:
	...
	enum
	{
		PARAMETER_ID_interfaceName = 0x10000016,
		PARAMETER_ID_userNetworking = 0x10000017,
		PARAMETER_ID_userNetSubnet = 0x10000018,
		PARAMETER_ID_userNetPorts = 0x10000019,
	};
