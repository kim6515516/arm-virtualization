...
/** \file
 * Class definition for Component VE_CompactFlash.
 */

#ifndef Component_Component__VE_CompactFlash_ClassDef_h_
#define Component_Component__VE_CompactFlash_ClassDef_h_
...
class ParameterFilter_bus_slave_of_PVBusSlave_to_VE_CompactFlash : public ParameterFilter
{
public:
	ParameterFilter_bus_slave_of_PVBusSlave_to_VE_CompactFlash()
	{
...
#endif
Component__VE_CompactFlash: public SystemGenComponent
{
public:
    ...
    Component__VE_CompactFlash(const char *argv, sg::SimulationContext* simulationContext, const sg::Params & params);
    ~Component__VE_CompactFlash();
...
private:
	...
	ParameterFilter_bus_slave_of_PVBusSlave_to_VE_CompactFlash parameterFilter_bus_slave_of_PVBusSlave_to_VE_CompactFlash__;


	CADIParameterProxy *cadiParameterProxy_bus_slave_of_PVBusSlave_to_VE_CompactFlash__;
