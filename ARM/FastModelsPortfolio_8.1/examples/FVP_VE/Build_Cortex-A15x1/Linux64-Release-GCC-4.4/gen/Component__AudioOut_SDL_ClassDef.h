...
/** \file
 * Class definition for Component AudioOut_SDL.
 */

#ifndef Component_Component__AudioOut_SDL_ClassDef_h_
#define Component_Component__AudioOut_SDL_ClassDef_h_
...
#line 17 "/home/sxcheng/Workspace/kvm/ARM/FastModelsPortfolio_8.1/LISA/AudioOut_SDL.lisa"

    
         #include    "components/PVSDLAudioBuffer.h"
         #include    <string>
    
#line 43 "./Linux64-Release-GCC-4.4/gen/Component__AudioOut_SDL_ClassDef.h"
...
#endif
Component__AudioOut_SDL: public SystemGenComponent
{
public:
...
#line 42 "/home/sxcheng/Workspace/kvm/ARM/FastModelsPortfolio_8.1/LISA/AudioOut_SDL.lisa"
    
        PVSdlAudioBuffer*   audioBuf;
    
#line 87 "./Linux64-Release-GCC-4.4/gen/Component__AudioOut_SDL_ClassDef.h"
    ...
    Component__AudioOut_SDL(const char *argv, sg::SimulationContext* simulationContext, const sg::Params & params);
    ~Component__AudioOut_SDL();
	...
	void step();
	PVAudioBuffer* abstract_port__audio__getPVAudioBuffer(uint32_t depth);
	void abstract_port__audio__releasePVAudioBuffer(PVAudioBuffer* buf);
