...
/** \file
 * Class definition for Component VirtualEthernetCrossover.
 */

#ifndef Component_Component__VirtualEthernetCrossover_ClassDef_h_
#define Component_Component__VirtualEthernetCrossover_ClassDef_h_
...
#line 14 "/home/sxcheng/Workspace/kvm/ARM/FastModelsPortfolio_8.1/LISA/VirtualEthernetCrossover.lisa"
 
        #include "components/VirtualEthernet/Protocol/EthernetFrame.h"
        #include "stdio.h"
    
#line 42 "./Linux64-Release-GCC-4.4/gen/Component__VirtualEthernetCrossover_ClassDef.h"
#include "FVP_VE_Cortex_A15x1__VirtualEthernet_ClassDef.h"
...
#endif
Component__VirtualEthernetCrossover: public SystemGenComponent
{
public:
    ...
    // abstract ports
	FVP_VE_Cortex_A15x1__VirtualEthernet deva;
	FVP_VE_Cortex_A15x1__VirtualEthernet devb;
...
#line 19 "/home/sxcheng/Workspace/kvm/ARM/FastModelsPortfolio_8.1/LISA/VirtualEthernetCrossover.lisa"

    
#line 86 "./Linux64-Release-GCC-4.4/gen/Component__VirtualEthernetCrossover_ClassDef.h"
    ...
    Component__VirtualEthernetCrossover(const char *argv, sg::SimulationContext* simulationContext, const sg::Params & params);
    ~Component__VirtualEthernetCrossover();
	...
	void step();
	void abstract_port__deva__sendToSlave(EthernetFrame* frame);
	void abstract_port__devb__sendToSlave(EthernetFrame* frame);
