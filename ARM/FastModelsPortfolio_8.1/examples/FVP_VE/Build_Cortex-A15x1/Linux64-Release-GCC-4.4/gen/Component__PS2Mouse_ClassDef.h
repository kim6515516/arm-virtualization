...
/** \file
 * Class definition for Component PS2Mouse.
 */

#ifndef Component_Component__PS2Mouse_ClassDef_h_
#define Component_Component__PS2Mouse_ClassDef_h_
...
#line 20 "/home/sxcheng/Workspace/kvm/ARM/FastModelsPortfolio_8.1/LISA/PS2Mouse.lisa"

    
        #define debug_queue if (!0) ; else printf
        #define TRACE_MOUSE if (!0) ; else printf
    
#line 43 "./Linux64-Release-GCC-4.4/gen/Component__PS2Mouse_ClassDef.h"
...
#endif
Component__PS2Mouse: public SystemGenComponent
{
public:
	...
	FVP_VE_Cortex_A15x1__TimerControl __PS2Mouse_internal_1;
...
#line 38 "/home/sxcheng/Workspace/kvm/ARM/FastModelsPortfolio_8.1/LISA/PS2Mouse.lisa"
...
#line 130 "./Linux64-Release-GCC-4.4/gen/Component__PS2Mouse_ClassDef.h"
    ...
    Component__PS2Mouse(const char *argv, sg::SimulationContext* simulationContext, const sg::Params & params);
    ~Component__PS2Mouse();
	...
	void abstract_port__mouse__mouseMove(int dx, int dy);
	void abstract_port__mouse__mouseButton(uint8_t button, bool down);
