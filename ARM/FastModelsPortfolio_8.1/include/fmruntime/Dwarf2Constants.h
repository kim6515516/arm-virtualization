/*
 * $Id: Dwarf2Constants.h 29787 2013-03-01 10:40:01Z brifol01 $
 *
 * $Author: brifol01 $
...
#ifndef _Dwarf2Constants_h_
#define _Dwarf2Constants_h_
...
#define DW_AT_stride                  0x51          // block, constant, reference
...
// SGI/MIPS extensions:
#define DW_AT_MIPS_linkage_name       0x2007        // string (appears in ARM/x86 gcc generated code and contains the mangeled name for a function/variable)
#define DW_AT_lo_user                 0x2000
#define DW_AT_hi_user                 0x3fff


#define DW_FORM_addr                  0x01          // address             ReadIntValue()
#define DW_FORM_block2                0x03          // block               ReadBlockValue()
#define DW_FORM_block4                0x04          // block               ReadBlockValue()
#define DW_FORM_data2                 0x05          // constant            ReadIntValue()
#define DW_FORM_data4                 0x06          // constant            ReadIntValue()
#define DW_FORM_data8                 0x07          // constant            ReadIntValue()
#define DW_FORM_string                0x08          // string              ReadStringValue()
#define DW_FORM_block                 0x09          // block               ReadBlockValue()
#define DW_FORM_block1                0x0a          // block               ReadBlockValue()
#define DW_FORM_data1                 0x0b          // constant            ReadIntValue()
#define DW_FORM_flag                  0x0c          // flag                ReadIntValue()
#define DW_FORM_sdata                 0x0d          // constant            ReadIntValue()
#define DW_FORM_strp                  0x0e          // string              ReadStringValue()
#define DW_FORM_udata                 0x0f          // constant            ReadIntValue()
#define DW_FORM_ref_addr              0x10          // reference           ReadReferenceValue()
#define DW_FORM_ref1                  0x11          // reference           ReadReferenceValue()
#define DW_FORM_ref2                  0x12          // reference           ReadReferenceValue()
#define DW_FORM_ref4                  0x13          // reference           ReadReferenceValue()
#define DW_FORM_ref8                  0x14          // reference           ReadReferenceValue()
#define DW_FORM_ref_udata             0x15          // reference           ReadReferenceValue()
#define DW_FORM_indirect              0x16          // (see section 7.5.3) one of the above


#define DW_OP_addr                    0x03          // 1 constantaddress(sizetargetspecific)
#define DW_OP_deref                   0x06          // 0
#define DW_OP_const1u                 0x08          // 1 1-byteconstant
#define DW_OP_const1s                 0x09          // 1 1-byteconstant
#define DW_OP_const2u                 0x0a          // 1 2-byteconstant
#define DW_OP_const2s                 0x0b          // 1 2-byteconstant
#define DW_OP_const4u                 0x0c          // 1 4-byteconstant
#define DW_OP_const4s                 0x0d          // 1 4-byteconstant
#define DW_OP_const8u                 0x0e          // 1 8-byteconstant
#define DW_OP_const8s                 0x0f          // 1 8-byteconstant
#define DW_OP_constu                  0x10          // 1 ULEB128constant
#define DW_OP_consts                  0x11          // 1 SLEB128constant
#define DW_OP_dup                     0x12          // 0
#define DW_OP_drop                    0x13          // 0
#define DW_OP_over                    0x14          // 0
#define DW_OP_pick                    0x15          // 1 1-bytestackindex
...
#define DW_OP_plus_uconst             0x23          // 1 ULEB128addend
#define DW_OP_shl                     0x24          // 0
#define DW_OP_shr                     0x25          // 0
#define DW_OP_shra                    0x26          // 0
#define DW_OP_xor                     0x27          // 0
#define DW_OP_skip                    0x2f          // 1 signed2-byteconstant
#define DW_OP_bra                     0x28          // 1 signed2-byteconstant
...
#define DW_OP_lit0                    0x30          // 0 literals 0..31
...
#define DW_OP_reg0                    0x50          // 0 reg 0..31
...
#define DW_OP_breg0                   0x70          // 1 breg 0..31  (SLEB128 offset)
...
#define DW_OP_call_ref                0x9a          // 1 4/8-byte offset of DIE
#define DW_OP_from_tls_address        0x9b          // 0
...
#define DW_CFA_advance_loc            0x40          // low6bits: delta
#define DW_CFA_offset                 0x80          // low6bits: register op1: ULEB128 offset
#define DW_CFA_restore                0xc0          // low6bits: register
#define DW_CFA_nop                    0x00
#define DW_CFA_set_loc                0x01          // op1: address
#define DW_CFA_advance_loc1           0x02          // op1: 1-bytedelta
#define DW_CFA_advance_loc2           0x03          // op1: 2-bytedelta
#define DW_CFA_advance_loc4           0x04          // op1: 4-bytedelta
#define DW_CFA_offset_extended        0x05          // op1: ULEB128 register op2: ULEB128 offset
#define DW_CFA_restore_extended       0x06          // op1: ULEB128 register
#define DW_CFA_undefined              0x07          // op1: ULEB128 register
#define DW_CFA_same_value             0x08          // op1: ULEB128 register
#define DW_CFA_register               0x09          // op1: ULEB128 register op2: ULEB128 register
#define DW_CFA_remember_state         0x0a
#define DW_CFA_restore_state          0x0b
#define DW_CFA_def_cfa                0x0c          // op1: ULEB128 register op1: ULEB128 offset
#define DW_CFA_def_cfa_register       0x0d          // op1: ULEB128 register
#define DW_CFA_def_cfa_offset         0x0e          // op1: ULEB128 offset
// dwarf 3:
#define DW_CFA_def_cfa_expresssion    0x0f          // DWARF 3: op1: BLOCK
#define DW_CFA_expression             0x10          // DWARF 3: op1: ULEB128 register op2: BLOCK
#define DW_CFA_offset_extended_sf     0x11          // DWARF 3: op1: ULEB128 register op2: SLEB128 offset
#define DW_CFA_def_cfa_sf             0x12          // DWARF 3: op1: ULEB128 register op2: SLEB128 offset
#define DW_CFA_def_cfa_offset_sf      0x13          // DWARF 3: op1: SLEB128 offset
#define DW_CFA_val_offset             0x14          // DWARF 3: op1: ULEB128 op2: ULEB128
#define DW_CFA_val_offset_sf          0x15          // DWARF 3: op1: ULEB128 op2: SLEB128
#define DW_CFA_val_expression         0x16          // DWARF 3: op1: ULEB128 op2: BLOCK
#define DW_CFA_lo_user                0x1c
#define DW_CFA_hi_user                0x3f


// jo: I added these constants to have numeric tags for the register rules for the call frame information (field 'rule' in )
#define DW_CFA_RR_undefined           0  /* the numeric parameter n is ignored */
#define DW_CFA_RR_same_value          1  /* the numeric parameter n is ignored */
#define DW_CFA_RR_offset              2  /* the numeric parameter n is the offset which is added to the CFA to get the register value in the previous frame */
#define DW_CFA_RR_register            3  /* the numeric parameter n is the register number of the register to get the register value in the previous frame */
#define DW_CFA_RR_unspecified         4  /* the numeric parameter n is ignored, behaves like same_value, occurs if none of the above actions is specified for a register */


#endif /* _Dwarf2Constants_h_ */
