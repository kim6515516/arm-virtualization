...
// Portions Copyright 2013 ARM Limited. All rights reserved.
//
// The ARM changes made relative to FastDelegate.h 1.5 are to quell GCC 4.8 unused local typedef
// warnings. These can safely be undone if using GCC <4.8, or by using -Wno-unused-local-typedefs
// The modifications #include "sg/Attributes.h" adding an ASSER_DECL macro, and change all
// typedef ERROR_* declarations to SG_ASSERT_DECL ERROR_* ... SG_UNUSED
// Eg
//     typedef char ERROR_Unsupported_member_function_pointer_on_this_compiler[N-100];
// becomes
//     SG_ASSERT_DECL ERROR_Unsupported_member_function_pointer_on_this_compiler[N-100] SG_UNUSED;
...
#ifdef _MSC_VER
        #define SG_ASSERT_DECL typedef int
#else
        #define SG_ASSERT_DECL extern int
#endif
...
inline OutputClass horrible_cast(const InputClass input){
        ...
        SG_ASSERT_DECL ERROR_CantUseHorrible_cast[sizeof(InputClass)==sizeof(u)
                && sizeof(InputClass)==sizeof(OutputClass) ? 1 : -1] SG_UNUSED;
        u.in = input;
        return u.out;
}
...
struct SimplifyMemFunc< SINGLE_MEMFUNCPTR_SIZE + sizeof(int) >  {
        ...
        union {
                ...
                SG_ASSERT_DECL ERROR_CantUsehorrible_cast[sizeof(function_to_bind)==sizeof(u.s)? 1 : -1] SG_UNUSED;
...
struct MicrosoftVirtualMFP {
        ...
        ptrdiff_t delta;              // #bytes to be added to the 'this' pointer
        ptrdiff_t vtable_index; // or 0 if no virtual inheritance
};
...
template <>
struct SimplifyMemFunc<SINGLE_MEMFUNCPTR_SIZE + 2*sizeof(ptrdiff_t) >
{
        ...
        inline static GenericClass *Convert(X *pthis, XFuncType function_to_bind,
                ...
                SG_ASSERT_DECL ERROR_CantUsehorrible_cast[sizeof(function_to_bind)==sizeof(u.s)
                        && sizeof(function_to_bind)==sizeof(u.ProbeFunc)
                        && sizeof(u2.virtfunc)==sizeof(u2.s) ? 1 : -1] SG_UNUSED;
...
struct SimplifyMemFunc<SINGLE_MEMFUNCPTR_SIZE + 3*sizeof(int) >
{
        ...
        inline static GenericClass *Convert(X *pthis, XFuncType function_to_bind,
                ...
                SG_ASSERT_DECL ERROR_VC6CompilerBug[-100] SG_UNUSED;
                return 0;
        }
};
...
struct SimplifyMemFunc<SINGLE_MEMFUNCPTR_SIZE + 3*sizeof(int) >
{
        ...
        inline static GenericClass *Convert(X *pthis, XFuncType function_to_bind,
                ...
                // Check that the horrible_cast will work
                SG_ASSERT_DECL ERROR_CantUsehorrible_cast[sizeof(XFuncType)==sizeof(u.s)? 1 : -1] SG_UNUSED;
                u.func = function_to_bind;
...
// support static_cast between void * and function pointers.
        ...
        inline void bindstaticfunc(DerivedClass *pParent, ParentInvokerSig static_function_invoker,
                ...
                SG_ASSERT_DECL ERROR_CantUseEvilMethod[sizeof(GenericClass *)==sizeof(function_to_bind) ? 1 : -1] SG_UNUSED;
...
//              m_pthis = reinterpret_cast<GenericClass *>(reinterpret_cast<long>(function_to_bind));
        ...
        inline UnvoidStaticFuncPtr GetStaticFunction() const {
                ...
                // and data pointers have different sizes.
                // If you get this error, you need to #undef FASTDELEGATE_USESTATICFUNCTIONHACK.
                SG_ASSERT_DECL ERROR_CantUseEvilMethod[sizeof(UnvoidStaticFuncPtr)==sizeof(this) ? 1 : -1] SG_UNUSED;
