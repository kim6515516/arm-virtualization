...
#ifndef ARM_SG_COMPONENT_H
#define ARM_SG_COMPONENT_H
...
public:
    /*! Provide a port that can be used to control this component's life-span.
     *  This port will be published as '$control'.
     */
    SGControlProtocol control_port;

    /*! Provide a port that can be used to control all child components.
     *  This port will be connected to the $control port on all children.
     */
    SGControlProtocol child_control_port;
...
protected:
    ...
    bool addPort(const std::string& name_, Port& port) {
        return publishPeerPort(name_, port);
    }
...
class GroupComponent : public Component {
  public:
    GroupComponent(std::string const & name_) : Component(name_) { }
};

} // namespace sg

#endif // ARM_SG_COMPONENT_H
